...
pub use super::{
    event::{
        ...
        new_note, new_empty_note, new_empty_note_event, new_note_event, new_note_event_sequence,
...
#[cfg(feature = "player")]
pub use super::player::{NewNoteAction, SamplePlayer, SamplePlaybackContext, SamplePool};
