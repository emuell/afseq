...
// questionable chords
const SEVEN_FLAT10: [u8; 5] = [0, 4, 7, 10, 15];
const NINE_SHARP5: [u8; 3] = [0, 1, 13];
const MINOR9SHARP5: [u8; 3] = [0, 1, 14];
const SEVEN_SHARP5FLAT9: [u8; 5] = [0, 4, 8, 10, 13];
const MINOR7SHARP5FLAT9: [u8; 5] = [0, 3, 8, 10, 13];
const ELEVEN_SHARP: [u8; 6] = [0, 4, 7, 10, 14, 18];
const MINOR11SHARP: [u8; 6] = [0, 3, 7, 10, 14, 18];
...
lazy_static! {
    static ref CHORD_TABLE: HashMap<&'static str, Vec<u8>> = {
        HashMap::from([
            ...
            ("sixby9", Vec::from(SIX_NINE)),
            ("6by9", Vec::from(SIX_NINE)),
            ...
            ("sevenFlat5", Vec::from(SEVEN_FLAT5)),
            ("7f5", Vec::from(SEVEN_FLAT5)),
            ("sevenSharp5", Vec::from(SEVEN_SHARP5)),
            ("7s5", Vec::from(SEVEN_SHARP5)),
            ("sevenFlat9", Vec::from(SEVEN_FLAT9)),
            ...
            ("minorSharp5", Vec::from(MINOR_SHARP5)),
            ("msharp5", Vec::from(MINOR_SHARP5)),
            ("mS5", Vec::from(MINOR_SHARP5)),
            ("minor6", Vec::from(MINOR6)),
            ("min6", Vec::from(MINOR6)),
            ("m6", Vec::from(MINOR6)),
            ("minorSixNine", Vec::from(MINOR_SIX_NINE)),
            ("minor69", Vec::from(MINOR_SIX_NINE)),
            ("min69", Vec::from(MINOR_SIX_NINE)),
            ("minSixNine", Vec::from(MINOR_SIX_NINE)),
            ("m69", Vec::from(MINOR_SIX_NINE)),
            ("mSixNine", Vec::from(MINOR_SIX_NINE)),
            ("m6by9", Vec::from(MINOR_SIX_NINE)),
            ("minor7flat5", Vec::from(MINOR7FLAT5)),
            ("minor7f5", Vec::from(MINOR7FLAT5)),
            ("min7flat5", Vec::from(MINOR7FLAT5)),
            ("min7f5", Vec::from(MINOR7FLAT5)),
            ("m7flat5", Vec::from(MINOR7FLAT5)),
            ("m7f5", Vec::from(MINOR7FLAT5)),
            ("minor7", Vec::from(MINOR7)),
            ("min7", Vec::from(MINOR7)),
            ("m7", Vec::from(MINOR7)),
            ("minor7sharp5", Vec::from(MINOR7SHARP5)),
            ("minor7s5", Vec::from(MINOR7SHARP5)),
            ("min7sharp5", Vec::from(MINOR7SHARP5)),
            ("min7s5", Vec::from(MINOR7SHARP5)),
            ("m7sharp5", Vec::from(MINOR7SHARP5)),
            ("m7s5", Vec::from(MINOR7SHARP5)),
            ("minor7flat9", Vec::from(MINOR7FLAT9)),
            ("minor7f9", Vec::from(MINOR7FLAT9)),
            ("min7flat9", Vec::from(MINOR7FLAT9)),
            ("min7f9", Vec::from(MINOR7FLAT9)),
            ("m7flat9", Vec::from(MINOR7FLAT9)),
            ("m7f9", Vec::from(MINOR7FLAT9)),
            ("minor7sharp9", Vec::from(MINOR7SHARP9)),
            ("minor7s9", Vec::from(MINOR7SHARP9)),
            ("min7sharp9", Vec::from(MINOR7SHARP9)),
            ("min7s9", Vec::from(MINOR7SHARP9)),
            ("m7sharp9", Vec::from(MINOR7SHARP9)),
            ("m7s9", Vec::from(MINOR7SHARP9)),
            ...
            ("sus2", Vec::from(SUS2)),
            ("sus4", Vec::from(SUS4)),
            ("sevenSus2", Vec::from(SEVEN_SUS2)),
            ("7sus2", Vec::from(SEVEN_SUS2)),
            ("sevenSus4", Vec::from(SEVEN_SUS4)),
            ("7sus4", Vec::from(SEVEN_SUS4)),
            ("nineSus4", Vec::from(NINE_SUS4)),
            ("ninesus4", Vec::from(NINE_SUS4)),
            ("9sus4", Vec::from(NINE_SUS4)),
            ("sevenFlat10", Vec::from(SEVEN_FLAT10)),
            ("7f10", Vec::from(SEVEN_FLAT10)),
            ("nineSharp5", Vec::from(NINE_SHARP5)),
            ("9sharp5", Vec::from(NINE_SHARP5)),
            ("9s5", Vec::from(NINE_SHARP5)),
            ("minor9sharp5", Vec::from(MINOR9SHARP5)),
            ("minor9s5", Vec::from(MINOR9SHARP5)),
            ("min9sharp5", Vec::from(MINOR9SHARP5)),
            ("min9s5", Vec::from(MINOR9SHARP5)),
            ("m9sharp5", Vec::from(MINOR9SHARP5)),
            ("m9s5", Vec::from(MINOR9SHARP5)),
            ("sevenSharp5flat9", Vec::from(SEVEN_SHARP5FLAT9)),
            ("7s5f9", Vec::from(SEVEN_SHARP5FLAT9)),
            ("minor7sharp5flat9", Vec::from(MINOR7SHARP5FLAT9)),
            ("m7sharp5flat9", Vec::from(MINOR7SHARP5FLAT9)),
            ("elevenSharp", Vec::from(ELEVEN_SHARP)),
            ("11s", Vec::from(ELEVEN_SHARP)),
            ("minor11sharp", Vec::from(MINOR11SHARP)),
            ("m11sharp", Vec::from(MINOR11SHARP)),
            ("m11s", Vec::from(MINOR11SHARP)),
        ])
    };
}
