...
### pop_back(self : [`Pattern`](../API/Pattern.md)) {#pop_back}
...
> p:pop_back() -- {}
> ```
### push_back(self : [`Pattern`](../API/Pattern.md), ...[`PulseValue`](#PulseValue)[] | [`PulseValue`](#PulseValue)) {#push_back}
`->`[`Pattern`](../API/Pattern.md)  
...
> ```
### take(self : [`Pattern`](../API/Pattern.md), length : [`integer`](../API/builtins/integer.md), empty_value : [`PulseValue`](#PulseValue)[`?`](../API/builtins/nil.md)) {#take}
`->`[`Pattern`](../API/Pattern.md)  
